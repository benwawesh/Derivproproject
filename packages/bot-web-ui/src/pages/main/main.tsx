...
const AppWrapper = observer(() => {
    ...
    const [is_bot_mode, setIsBotMode] = React.useState(false);
    ...
    React.useEffect(() => {
        if (localStorage.getItem('dpa_bot_mode') === '1') {
            localStorage.removeItem('dpa_bot_mode');
            setIsBotMode(true);
            ...
            <div className='main'>
                ...
                >
                    <Tabs
                        ...
                        className={classNames('main__tabs', { 'main__tabs--bot-mode': is_bot_mode })}
