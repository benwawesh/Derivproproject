...
export default class RunPanelStore {
    ...
    registerBotListeners = () => {
        ...
        // Stop bot when user switches away from funded mode so trades
        // don't continue through the funded engine on the new account
        window.addEventListener('dpa_funded_bot_stop', this._onFundedBotStop);
    };
    ...
    unregisterBotListeners = () => {
        ...
        window.removeEventListener('dpa_funded_bot_stop', this._onFundedBotStop);
    };
