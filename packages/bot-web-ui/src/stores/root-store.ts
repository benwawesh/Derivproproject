...
import funded_account_singleton, { FundedAccountStore } from './funded-account-store';
...
export default class RootStore {
    ...
    public funded_account: FundedAccountStore;
    ...
    constructor(core: TStores, ws: TWebSocket, dbot: TDbot) {
        ...
        this.funded_account = funded_account_singleton;
