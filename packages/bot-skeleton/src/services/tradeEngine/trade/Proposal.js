...
import { FundedTradeEngine } from '../../funded/funded-trade-engine';
...
export default Engine =>
    class Proposal extends Engine {
        ...
        requestProposals() {
            // In marketing or funded mode, skip real API — proposals aren't needed
            // because _executeMarketingTrade / _executeFundedTrade bypass them entirely.
            if (MarketingTradeEngine.isActive() || FundedTradeEngine.isActive()) {
