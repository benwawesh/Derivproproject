...
const CopyTradingPage = React.lazy(() => import('App/Containers/CopyTrading'));
const MyReportsPage = React.lazy(() => import('App/Containers/MyReports'));
const AdminPage = React.lazy(() => import('App/Containers/DPAAdmin'));
const SuperBotsPage = React.lazy(() => import('App/Containers/SuperBots'));
const MultiMarketDiffersBot = React.lazy(() =>
    import('Modules/SuperBots/MultiMarketDiffers').then(m => ({ default: m.MultiMarketDiffersBot }))
);
const DPAHomepage = React.lazy(() => import('App/Components/DPAHomepage'));
const DerivHomepage = React.lazy(() =>
    moduleLoader(() => import(/* webpackChunkName: "appstore" */ '@deriv/appstore'))
);
...
const getModules = () => {
    const modules = [
        ...
        },
        {
            ...
            component: FreeBotsPage,
            is_authenticated: false,
            getTitle: () => 'Free Bots',
        },
        {
            path: routes.analysis_tool,
            component: AnalysisToolPage,
            is_authenticated: false,
            getTitle: () => 'Analysis Tool',
        },
        {
            path: routes.risk_calculator,
            component: RiskCalculatorPage,
            is_authenticated: false,
            getTitle: () => 'Risk Calculator',
        },
        {
        ...
        {
            path: routes.multi_market_differs,
            component: MultiMarketDiffersBot,
            is_authenticated: false,
            exact: true,
            getTitle: () => 'Multi-Market Differs Bot',
        },
        {
            path: routes.premium_bots,
            component: SuperBotsPage,
            is_authenticated: false,
            exact: true,
            getTitle: () => 'Super Bots',
        },
